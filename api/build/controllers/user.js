    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _passport["default"].authenticate('register', /*#__PURE__*/function () {
              var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(err, user, info) {
                return _regeneratorRuntime().wrap(function _callee$(_context) {
                  while (1) {
                    switch (_context.prev = _context.next) {
                      ...
                      case 2:
                        info !== undefined ? res.status(403).send({
                          error: true,
        ...
        switch (_context3.prev = _context3.next) {
          case 0:
            _passport["default"].authenticate('jwt', {
              ...
              if (info != undefined || !user) return res.status(403).json({
                error: true,
        ...
        switch (_context5.prev = _context5.next) {
          case 0:
            _passport["default"].authenticate('login', /*#__PURE__*/function () {
              var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(err, users, info) {
                var user, token;
