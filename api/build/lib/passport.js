    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 9:
            return _context.abrupt("return", done(null, create));
...
_passport["default"].use('login', new _passportLocal.Strategy({
  ...
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(username, password, done) {
    var user;
